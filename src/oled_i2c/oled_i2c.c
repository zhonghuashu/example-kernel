/**
 * @file oled_i2c.c
 * @brief SSD_1306 OLED (0.91 inch) Display I2C driver
 * https://www.waveshare.net/wiki/0.91inch_OLED_Module
...
/*
** Array Variable to store the letters. One character in 8 rows (1 byte) x 5 columns.
*/
